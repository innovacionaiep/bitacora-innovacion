  ...
  try {
    ...
    const indicadoresData = [
      {
        ...
        descripcion:
          'Permite cuantificar el nivel de desconocimiento o necesidad formativa en herramientas digitales dentro de la comunidad haitiana. Es clave para diseñar capacitaciones pertinentes. Esperado: Al menos un 80% de las personas encuestadas manifiestan necesidades en alfabetización digital y uso de plataformas.',
        formaCalculo:
          '(N° de encuestados con brechas / Total encuestados) * 100',
      ...
      {
        nombre:
          'Se compromete un 80% de satisfacción (profundizar según herramienta y método a aplicar)',
        descripcion:
          'Encuesta de satisfacción a los estudiantes con el proceso al cierre del proceso.',
        formaCalculo:
          'Encuesta de satisfacción a los estudiantes con el proceso al cierre del proceso.',
        resultadoEsperado: '80%',
      ...
      },
      {
        ...
        descripcion:
          'Mide la efectividad en la convocatoria y participación real de la comunidad haitiana en los talleres impartidos, reflejando interés y pertinencia. Esperado: Realizar al menos 4 talleres, con una asistencia efectiva de al menos 80% de inscritos en cada uno.',
      ...
      },
      {
        ...
        descripcion:
          'Indicador que mide la retención y finalización exitosa del programa de capacitación por parte de los participantes inscritos.',
        formaCalculo:
          '(N° participantes que completan / N° participantes inscritos) * 100',
      ...
      },
      {
        ...
        descripcion:
          'Mide el cumplimiento del cronograma establecido para la implementación de los talleres formativos.',
        formaCalculo:
          '(N° talleres realizados / N° talleres programados) * 100',
    ...
    for (const proyecto of proyectos) {
      if (proyecto.objetivos_rel.length === 0) {
        console.log(
          `Proyecto ${proyecto.proyecto} no tiene objetivos específicos, saltando...`
        );
        continue;
      }
      ...
      for (
        let i = 0;
        i < proyecto.objetivos_rel.length && i < indicadoresData.length;
        i++
      ) {
