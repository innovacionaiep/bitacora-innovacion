      ...
      <div className="flex space-x-4">
        ...
        <div className="flex-1 relative" style={{ paddingTop: '42px' }}>
          <div className="w-full h-px bg-gray-300 relative">
            <div className="absolute right-0 w-0 h-0 border-l-[6px] border-l-gray-300 border-t-[4px] border-t-transparent border-b-[4px] border-b-transparent" style={{ top: '-4px' }}></div>
          </div>
        </div>
